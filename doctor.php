	...
	<div class="uk-position-center">
			<div class="uk-card uk-card-default uk-card-body">
				<form method="post" action="doctorlogin.php">
					...
					<div class="uk-margin">
						<input type="text" name="docname" class="uk-input" placeholder="username" required>
					</div>
					<div class="uk-margin">
					   <input type="password" name="docpass" class="uk-input" placeholder="password" required>
					</div>
					<div class="uk-margin">
